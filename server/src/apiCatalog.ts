export const apiCatalog = {
  ...
  groups: {
    ...
    operations: ["GET /notifications", "PATCH /notifications/:id/read", "POST /notifications/read-all", "GET /audit-logs", "GET /integrations/:kind", "POST /integrations/:kind", "DELETE /integrations/:kind/:id", "GET /settings", "PATCH /settings", "GET /sla", "PATCH /sla/policy", "PATCH /organization", "DELETE /organization", "GET /organization/usage", "GET /export", "POST /import/resources", "GET /reports", "GET /reports/cycle-time", "GET /dashboard"],
    intelligence: ["POST /analysis/sprint-risk", "GET /analysis/examples", "GET /ai/endpoints", "POST /ai/execute", "GET /ai/models", "POST /ai/chat", "POST /ai/generate-tickets", "POST /ai/confirm-ticket-plan"],
  },
};
