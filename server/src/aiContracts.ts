...
const contracts: Record<string, Omit<AiMutationContract, "endpoint">> = {
  ...
  "POST /tickets/:id/attachments": { body: "{ name: string (min 1), url?: valid URL, dataUrl?: base64 data URL, mimeType?: string, size?: integer 0..650000 }. Supply either url or dataUrl." },
