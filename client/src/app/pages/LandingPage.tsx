...
export function LandingPage() {
  ...
  useEffect(() => {
    let active = true;
    void hasSession().then((authenticated) => { if (active) setIsLoggedIn(authenticated); });
    ...
    <div className="landing">
      <header className="landing-nav">
        ...
        <div className="landing-actions">
          ...
          <Link className="landing-button small" to="/register">Start free <Icons.ArrowUpRight /></Link>
        </div>
      </header>
      ...
      <main id="top">
        ...
        <section className="landing-hero">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <Link className="landing-button" to="/register">Start tracking for free <Icons.ArrowRight /></Link>
        ...
        <section className="cta-section" id="pricing"><div><span className="section-kicker">YOUR NEXT SPRINT STARTS HERE</span><h2>Ready to move<br/>with clarity?</h2></div><div><p>Bring your team, your work, and your ambition. I-TRACK will help you keep the rest on track.</p><Link className="landing-button dark" to="/register">Start for free <Icons.ArrowRight/></Link><small>Free forever for teams up to 10</small></div></section>
      </main>
      <footer className="landing-footer"><a className="landing-logo" href="#top"><span><img src="/logo-mark-soft-purple.png" alt="" /></span>I-TRACK</a><p>© {year} I-TRACK. Built for momentum.</p><div><a href="#features">Product</a><a href="#pricing">Pricing</a><Link to="/login">Log in</Link></div></footer>
    </div>
  );
}
